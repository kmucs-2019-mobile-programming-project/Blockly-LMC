package kmucs.mobileprogramming.team.a.blocklylmc.materialshowcaseview;
...
import kmucs.mobileprogramming.team.a.blocklylmc.materialshowcaseview.shape.Shape;
import kmucs.mobileprogramming.team.a.blocklylmc.materialshowcaseview.target.PointRadiusTarget;
import kmucs.mobileprogramming.team.a.blocklylmc.materialshowcaseview.target.Target;
import kmucs.mobileprogramming.team.a.blocklylmc.materialshowcaseview.shape.CircleShape;
import kmucs.mobileprogramming.team.a.blocklylmc.materialshowcaseview.shape.NoShape;
import kmucs.mobileprogramming.team.a.blocklylmc.materialshowcaseview.shape.OvalShape;
import kmucs.mobileprogramming.team.a.blocklylmc.materialshowcaseview.shape.RectangleShape;
import kmucs.mobileprogramming.team.a.blocklylmc.materialshowcaseview.target.ViewTarget;
...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    public void setPointRadius(Point targetPoint, int radius) {
        // update dismiss button state
        updateDismissButton();
    ...
    public static class Builder {
        ...
        private static final int CUSTOM_SHAPE = 4;
        ...
        public Builder setTarget(Point targetPoint, int radius) {
            showcaseView.setTarget(new PointRadiusTarget(targetPoint, radius));
            return this;
        }
        ...
        public Builder withCustomShape() {
        ...
        public MaterialShowcaseView build() {
            if (showcaseView.mShape == null) {
                switch (shapeType) {
                    ...
                    case CUSTOM_SHAPE: {
                        showcaseView.setShape(new CircleShape(showcaseView.mRadius));
                        break;
                    }
                }
            }
    ...
    public void fadeIn() {
        setVisibility(INVISIBLE);
        Point point = (mTarget == null) ? new Point(mXPosition, mYPosition) : mTarget.getPoint();
        mAnimationFactory.animateInView(this, point, mFadeDurationInMillis,
