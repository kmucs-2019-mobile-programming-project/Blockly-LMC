...
public class MaterialShowcaseSequence implements IDetachedListener {
    ...
    public MaterialShowcaseSequence addSequenceItem(Point point, int radius, String content, String dismissText) {
        addSequenceItem(point, radius, "", content, dismissText);
        return this;
    }
    ...
    public MaterialShowcaseSequence addSequenceItem(Point point, int radius, String title, String content, String dismissText) {

        MaterialShowcaseView sequenceItem = new MaterialShowcaseView.Builder(mActivity)
                .setTarget(point, radius)
                .setTitleText(title)
                .setDismissText(dismissText)
                .setContentText(content)
                .setSequence(true)
